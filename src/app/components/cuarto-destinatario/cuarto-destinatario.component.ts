...
@Component({
  selector: 'app-cuarto-destinatario',
  templateUrl: './cuarto-destinatario.component.html',
  styleUrls: ['./cuarto-destinatario.component.css']
})
export class CuartoDestinatarioComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.dataSubcripcion = this.destinatarioService.datosCuatro$
