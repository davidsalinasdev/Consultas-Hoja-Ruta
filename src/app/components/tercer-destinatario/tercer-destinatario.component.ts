...
@Component({
  selector: 'app-tercer-destinatario',
  templateUrl: './tercer-destinatario.component.html',
  styleUrls: ['./tercer-destinatario.component.css']
})
export class TercerDestinatarioComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.dataSubcripcion = this.destinatarioService.datosTres$
  ...
  */
  public verDestinatario(destinatarios: number) {
    ...
    this.destinatarioService.datosCuatro$.emit(datosEmit);
  }
